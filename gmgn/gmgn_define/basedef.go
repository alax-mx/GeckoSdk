...
const (
	ETH20_MAIN_ADDRESS  string = "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"
	ETH20_MAIN_DECIMALS int    = 18
...
const (
	...
	G_BASE_GMGN_SOL_TRADE_URL string = "https://gmgn.ai/defi/router/v1/sol/tx"
