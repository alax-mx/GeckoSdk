...
func (tpt *TokenLiquidityDetailTool) Get(tokenAddress string) (*GetTokenLiquidityDetailResp, error) {
	url := "vas/api/v1/token_liquidity_detail/sol/" + tokenAddress + "?" + tpt.baseParam
